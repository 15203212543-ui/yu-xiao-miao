const CACHE='yu-xiao-miao-pwa-v4';
const ASSETS=['./','./index.html','./styles.css','./app.js','./app.js?v=20260814','./record.js','./record.js?v=20260814','./manifest.webmanifest','./icon.svg'];
